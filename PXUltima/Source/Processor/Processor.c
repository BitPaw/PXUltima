...
void ProcessorModelNameGet(const ProcessorModelName processorModelName, char* const name)
{
...
ProcessorModelName ProcessorModelNameDetect(const ProcessorBrand processorBrand, const unsigned char famliy, const unsigned char model)
{       
