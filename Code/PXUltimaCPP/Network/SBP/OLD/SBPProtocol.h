...
#define ResponseID unsigned int
	...
	PXPublic void PXSBPPackageHeaderConstruct(SBPPackageHeader* const sbpPackageHeader);
	PXPublic void PXSBPPackageHeaderDestruct(SBPPackageHeader* const sbpPackageHeader);

	PXPublic void PXSBPPackageHeaderSet
	(
	...
	PXPublic void PXSBPPackageHeaderPrint(SBPPackageHeader* const sbpData);
	...
	PXPublic void PXSBPPackageHeaderPackageConnectionCreateFill(const SBPConnectionCreateReason reason);

	PXPublic PXSize PXSBPPackageHeaderPackageConnectionCreateParse(const void* inputData, const PXSize inputDataSize);
	PXPublic PXSize PXSBPPackageHeaderPackageConnectionCreateSerialize(void* outputData, const PXSize outputDataSize);
...
#define SBPPackageHeaderPackageFileModeIDRename 0x06
		...
		PXPublic void PXSBPPackageHeaderPackageFileConstruct(SBPPackageHeaderPackageFile* const sbpDataPackageFile);
		...
		PXPublic void PXSBPPackageHeaderPackageFileFill(SBPPackageHeaderPackageFile* const sbpDataPackageFile, const SBPPackageHeaderPackageFileMode mode, const char* source, const char* target);

		PXPublic PXSize PXSBPPackageHeaderPackageFileParse(SBPPackageHeaderPackageFile* const sbpDataPackageFile, const void* inputData, const PXSize inputDataSize);
		PXPublic PXSize PXSBPPackageHeaderPackageFileSerialize(SBPPackageHeaderPackageFile* const sbpDataPackageFile, void* outputData, const PXSize outputDataSize);
	...
	PXPublic PXSize PXSBPPackageHeaderPackageIamParse(SBPPackageHeader* const sbpDataPackage, SBPPackageHeaderPackageIam* const sbpDataPackageIam);
	PXPublic PXSize PXSBPPackageHeaderPackageIamSerialize(SBPPackageHeader* const sbpDataPackage, SBPPackageHeaderPackageIam* const sbpDataPackageIam);
	//-------------------------------------------------------------------------
...
#define SBPPackageHeaderPackageResponseTypeDeniedID 0x03
		...
		PXPublic void PXSBPPackageHeaderPackageResponseConstruct(SBPPackageHeaderPackageResponse* const sbpDataPackageResponse);

		PXPublic PXSize PXSBPPackageHeaderPackageResponseParse(SBPPackageHeaderPackageResponse* const sbpDataPackageResponse, const void* inputData, const PXSize inputDataSize);
		PXPublic PXSize PXSBPPackageHeaderPackageResponseSerialize(SBPPackageHeaderPackageResponse* const sbpDataPackageResponse, void* outputData, const PXSize outputDataSize);
...
#define SBPPackageHeaderPackageTextID MakeInt('T', 'e', 'x', 't')
	...
	PXPublic void PXSBPPackageHeaderPackageTextConstruct(SBPPackageHeaderPackageText* const sbpDataPackageText);
	PXPublic void PXSBPPackageHeaderPackageTextDestruct(SBPPackageHeaderPackageText* const sbpDataPackageText);

	PXPublic PXSize PXSBPPackageHeaderPackageTextParse(SBPPackageHeaderPackageText* const sbpDataPackageText, const void* inputData, const PXSize inputDataSize);
	PXPublic PXSize PXSBPPackageHeaderPackageTextSerialize(SBPPackageHeaderPackageText* const sbpDataPackageText, void* outputData, const PXSize outputDataSize);
