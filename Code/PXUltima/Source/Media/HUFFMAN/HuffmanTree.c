...
unsigned int GenerateDynamicTree(PXFile* const dataStream, HuffmanTree* treeLength, HuffmanTree* treeDistance)
{
...
unsigned int HuffmanSymbolDecode(PXFile* const dataStream, const HuffmanTree* const codetree)
{
