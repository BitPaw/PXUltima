...
namespace PX
{
	public enum class PXOpenGLVersion
	{
		Invalid,
		None,
		GLV1x0x0,
		...
		GLV3x3x0, // 2010 March    11. GLSL 3.30, Backports as much function as possible from the PXOpenGL 4.0 specification
		GLV4x0x0, // 2010 March    11. GLSL 4.00, Tessellation on GPU, shaders with 64 - bit precision
		GLV4x1x0, // 2010 July     26. GLSL 4.10, Developer - friendly debug outputs, compatibility with PXOpenGL ES 2.0
		...
		GLV4x3x0, // 2012 August    6. GLSL 4.30, Compute shaders leveraging GPU parallelism, shader storage buffer objects, high - quality ETC2 / EAC texture compression, increased memory security, a multi - application robustness extension, compatibility with PXOpenGL ES 3.0
		...
		GLV4x5x0,	// 2014 August   11. GLSL 4.50, Direct State Access(DSA), Flush Control, Robustness, PXOpenGL ES 3.1 API and shader compatibility, DX11 emulation features
	...
	public ref class PXOpenGL
	{
		...
		property PXOpenGLVersion Version { PXOpenGLVersion get() { return (PXOpenGLVersion)Context->Version; }}
