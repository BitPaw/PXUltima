...
PXVirtualKey PXAPI PXVirtualKeyFromID(const PXInt8U character)
{
    ...
    case VK_LSHIFT:
        return KeyShiftLeft; // 0xA0
    case VK_RSHIFT:
        return KeyShiftRight; // 0xA1

    case VK_LCONTROL:
        return KeyControlLeft; // 0xA2
    case VK_RCONTROL:
        return KeyControlRight; // 0xA3
...
PXKeyPressState PXAPI PXKeyPressStateFromID(const PXInt8U pxKeyPressStateID)
{
    ...
    {
    case 0:
        return PXKeyPressStateDown;
    case KEYEVENTF_KEYUP:
        return PXKeyPressStateUp;
    case KEYEVENTF_EXTENDEDKEY:
        return PXKeyPressStateHold;
