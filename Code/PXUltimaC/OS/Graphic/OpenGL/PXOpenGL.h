...
//---<PXOpenGL v.2.0.0>------------------------------------------------------
	...
	PXPublic void PXOpenGLViewPortSet(PXOpenGL* const openGLContext, const PXViewPort* const pxViewPort);
	PXPublic void PXOpenGLViewPortGet(PXOpenGL* const openGLContext, PXViewPort* const pxViewPort);
