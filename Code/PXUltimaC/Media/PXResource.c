...
const char* PXAPI PXVertexBufferFormatToString(const PXVertexBufferFormat pxVertexBufferFormat)
{
    switch(pxVertexBufferFormat)
    {
        ...
        case PXVertexBufferFormatC4UB_XY: return "C4UB_XY";
        case PXVertexBufferFormatC4UB_XYZ: return "C4UB_XYZ";
        ...
        case PXVertexBufferFormatT4F_XYZW: return "T4 P3 - float";
        case PXVertexBufferFormatT2F_C4UB_XYZ: return "T4 C4 P3 - float";
        case PXVertexBufferFormatT2F_C3F_XYZ: return "T2 C4 P3 - float";
        case PXVertexBufferFormatT2F_N3F_XYZ: return "T2 N3 P3 - float";
        case PXVertexBufferFormatT2F_C4F_N3F_XYZ: return "T2 C4 N3 P3 - float";
        case PXVertexBufferFormatT4F_C4F_N3F_XYZW: return "T4 C4 N3 P4 - float";
        case PXVertexBufferFormatXYZC: return "XYZC";
        case PXVertexBufferFormatXYZRHW: return "XYZRHW";
        case PXVertexBufferFormatXYZHWC: return "XYZHWC";
        case PXVertexBufferFormatXYZB1: return "XYZB1";
        case PXVertexBufferFormatXYZB2: return "XYZB2";
        case PXVertexBufferFormatXYZB3: return "XYZB3";
        case PXVertexBufferFormatXYZB4: return "XYZB4";
        case PXVertexBufferFormatXYZB5: return "XYZB5";  
