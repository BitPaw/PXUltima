...
DXGI_FORMAT PXDXGIFormatGet(PXDirectDrawTexture* const pxDirectDrawTexture)
{
    ...
    else if(pxDirectDrawTexture->Flags & DDS_FOURCC)
    {
        ...
        {
            case PXInt32Make('D', 'X', 'T', '1'): return DXGI_FORMAT_BC1_UNORM;
            case PXInt32Make('D', 'X', 'T', '3'): return DXGI_FORMAT_BC2_UNORM;
            case PXInt32Make('D', 'X', 'T', '5'): return DXGI_FORMAT_BC3_UNORM;
            // While pre-mulitplied alpha isn't directly supported by the DXGI formats,
            // they are basically the same as these BC formats so they can be mapped
            case PXInt32Make('D', 'X', 'T', '2'): return DXGI_FORMAT_BC2_UNORM;
            case PXInt32Make('D', 'X', 'T', '4'): return DXGI_FORMAT_BC3_UNORM; 
            case PXInt32Make('B', 'C', '4', 'U'): 
            case PXInt32Make('A', 'T', 'I', '1'): return DXGI_FORMAT_BC4_UNORM;
            case PXInt32Make('B', 'C', '4', 'S'): return DXGI_FORMAT_BC4_SNORM;
            case PXInt32Make('A', 'T', 'I', '2'):
            case PXInt32Make('B', 'C', '5', 'U'): return DXGI_FORMAT_BC5_UNORM;
            case PXInt32Make('B', 'C', '5', 'S'): return DXGI_FORMAT_BC5_SNORM;
   
            // BC6H and BC7 are written using the "DX10" extended header
            case PXInt32Make('R', 'G', 'B', 'G'): return DXGI_FORMAT_R8G8_B8G8_UNORM;
