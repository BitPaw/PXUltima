...
PXPlatformID PXAPI PXTTFPlatformFromID(const PXInt16U platformID)
{
    ...
    {
    case 0u:
        return PXPlatformUnicode;
    case 1u:
        return PXPlatformMacintosh;
    case 2u:
        return PXPlatformReserved;
    case 3u:
        return PXPlatformWindows;
...
PXEncodingID PXAPI PXTTFEncodingFromID(const PXPlatformID platformID, const PXInt16U encodingID)
{
    ...
    case PXPlatformUnicode:
    {
        ...
        {
        case 0:
            return PXEncodingUnicode10;
        case 1:
            return PXEncodingUnicode11;
        case 2:
            return PXEncodingISOIEC10646;
        case 3:
            return PXEncodingUnicode20BMPOnly;
        case 4:
            return PXEncodingUnicode20FullRepertoire;
        case 5:
            return PXEncodingUnicodeVariation;
        case 6:
            return PXEncodingUnicodeFullRepertoire;
        }
    ...
    case PXPlatformISO:
    {
        ...
        {
        case 0:
            return PXEncodingSevenBitASCII;
        case 1:
            return PXEncodingISO10646;
        case 2:
            return PXEncodingISO8858;
        }
    ...
    case PXPlatformWindows:
    {
        ...
        {
        case 0:
            return PXEncodingSymbol;
        case 1:
            return PXEncodingUnicodeBMP;
        case 2:
            return PXEncodingShiftJIS;
        case 3:
            return PXEncodingPRC;
        case 4:
            return PXEncodingBig5;
        case 5:
            return PXEncodingWansung;
        case 6:
            return PXEncodingJohab;
...
PXTTFVersionType PXAPI PXTTFVersionTypeFromID(unsigned short major, unsigned short minor)
{
    ...
    case 0:
    {
        ...
        {
        case 1:
            return PXTTFVersion1Dot0;
        case 2:
            return PXTTFVersion2Dot0;
        case 3:
            return PXTTFVersion3Dot0;
        }
