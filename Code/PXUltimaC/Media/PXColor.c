...
float PXAPI PXColorRGBToY(const float red, const float green, const float blue)
{
	return +0.299f * red + 0.587f * green + 0.114f * blue;
}

float PXAPI PXColorRGBToCb(const float red, const float green, const float blue)
{
	return -0.16874f * red - 0.33126f * green + 0.5f * blue;
} // ITU: -0.168736f * r -0.331264f * g +0.5f      * b

float PXAPI PXColorRGBToCr(const float red, const float green, const float blue)
{
