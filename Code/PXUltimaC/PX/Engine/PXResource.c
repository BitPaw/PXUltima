...
PXResult PXAPI PXResourceLoadA(PXResourceMoveInfo PXREF pxResourceLoadInfo, const char PXREF filePath)
{
    PXText pxText;
...
PXResult PXAPI PXResourceSave(PXResourceMoveInfo PXREF pxResourceSaveInfo, const PXText PXREF filePath)
{
    PXFile* pxFile = PXFileCreate();
