...
void PXAPI PXAudioSystemRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXAudioSystemRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXAudioSystemRegisterInfoDynamic;
}
