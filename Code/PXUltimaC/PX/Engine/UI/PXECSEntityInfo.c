...
void PXAPI PXECSEntityInfoRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXECSEntityInfoInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXECSEntityInfoInfoDynamic;
}
...
PXResult PXAPI PXECSEntityInfoDraw(PXECSEntityInfo PXREF pxECSEntityInfo, PXDrawInfo PXREF pxDrawInfo)
{
       ...
       pxDrawInfo->Behaviour |= PXWindowAllignLeft;
