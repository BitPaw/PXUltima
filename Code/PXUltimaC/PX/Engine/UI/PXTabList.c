...
void PXAPI PXTabListRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXTabListRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXTabListRegisterInfoDynamic;
}
