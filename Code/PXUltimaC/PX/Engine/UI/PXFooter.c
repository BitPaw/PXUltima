...
void PXAPI PXFooterRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXFooterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXFooterInfoDynamic;
}
