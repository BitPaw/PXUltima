...
PXResult PXAPI PXLevelLoadFromFile(PXResourceTransphereInfo PXREF pxResourceLoadInfo)
{
    // Signature
...
PXResult PXAPI PXLevelSaveToFile(PXResourceTransphereInfo PXREF pxResourceSaveInfo)
{
    PXLevel pxLevel;
