...
PXResult PXAPI  PXMCALoadFromFile(PXResourceTransphereInfo* const pxResourceLoadInfo)
{
...
PXResult PXAPI  PXMCASaveToFile(PXResourceTransphereInfo* const pxResourceSaveInfo)
{
    return PXActionRefusedNotImplemented;
}