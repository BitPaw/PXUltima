...
PXPublic PXResult PXAPI PXGIFLoadFromFile(PXECSCreateInfo PXREF pxResourceLoadInfo);
PXPublic PXResult PXAPI PXGIFSaveToFile(PXECSCreateInfo PXREF pxResourceSaveInfo);
