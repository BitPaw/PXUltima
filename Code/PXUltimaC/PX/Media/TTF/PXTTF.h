...
PXPublic PXResult PXAPI PXTTFLoadFromFile(PXECSCreateInfo PXREF pxResourceLoadInfo);
PXPublic PXResult PXAPI PXTTFSaveToFile(PXECSCreateInfo PXREF pxResourceSaveInfo);
