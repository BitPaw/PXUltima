...
PXResult PXAPI  PXPDFLoadFromFile(PXResourceTransphereInfo* const pxResourceLoadInfo)
{
    PXPDF pxPDF;
...
PXResult PXAPI  PXPDFSaveToFile(PXResourceTransphereInfo* const pxResourceSaveInfo)
{
