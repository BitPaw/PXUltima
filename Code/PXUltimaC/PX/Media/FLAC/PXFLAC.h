...
PXPublic PXResult PXAPI PXFLACLoadFromFile(PXECSCreateInfo PXREF pxResourceLoadInfo);
PXPublic PXResult PXAPI PXFLACSaveToFile(PXECSCreateInfo PXREF pxResourceSaveInfo);
