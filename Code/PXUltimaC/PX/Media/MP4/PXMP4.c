...
PXResult PXAPI PXMP4LoadFromFile(PXResourceTransphereInfo PXREF pxResourceLoadInfo)
{
...
PXResult PXAPI PXMP4SaveToFile(PXResourceTransphereInfo PXREF pxResourceSaveInfo)
{
