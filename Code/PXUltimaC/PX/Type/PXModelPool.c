...
void PXAPI PXModelPoolRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXModelPoolRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXModelPoolRegisterInfoDynamic;
}
