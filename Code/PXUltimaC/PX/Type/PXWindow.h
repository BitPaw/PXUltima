...
typedef struct PXDrawInfo_
{
    //-------------------------
    // Set by engine
    struct PXEngine* Engine;
    struct PXRenderer* Rendrer;
    //-------------------------
...
PXPublic void PXAPI PXWindowEventMouseEnter(PXWindow PXREF pxWindow, PXWindowEvent PXREF pxWindowEvent);
PXPublic void PXAPI PXWindowEventMouseLeave(PXWindow PXREF pxWindow, PXWindowEvent PXREF pxWindowEvent);
PXPublic void PXAPI PXWindowEventMouseClick(PXWindow PXREF pxWindow, PXWindowEvent PXREF pxWindowEvent);
PXPublic void PXAPI PXWindowEventMouseMove(PXWindow PXREF pxWindow, PXWindowEvent PXREF pxWindowEvent);

PXPublic void PXAPI PXWindowEventRender(PXWindow PXREF pxWindow, PXWindowEvent PXREF pxWindowEvent);

PXPublic void PXAPI PXWindowEventKeyboardInput(PXWindow PXREF pxWindow, PXWindowEvent PXREF pxWindowEvent);

PXPublic void PXAPI PXWindowEventResize(PXWindow PXREF pxWindow, PXWindowEvent PXREF pxWindowEvent);
PXPublic void PXAPI PXWindowEventMoved(PXWindow PXREF pxWindow, PXWindowEvent PXREF pxWindowEvent);
//---------------------------------------------------------
...
// Hirachy
//---------------------------------------------------------
PXPublic PXSize PXAPI PXWindowChildAmount(PXWindow PXREF pxWindow);
...
PXPublic PXWindow* PXAPI PXWindowParentGet(PXWindow PXREF pxWindow);
...
// Properties
//---------------------------------------------------------
PXPublic PXResult PXAPI PXWindowSpaceDrawGet(PXWindow PXREF pxWindow, PXRectangleXYWHI32 PXREF pxRectangle);
