...
void PXAPI PXMeshGeometryRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXMeshGeometryRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXMeshGeometryRegisterInfoDynamic;
}
