...
void PXAPI PXTextureSetRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXTextureSetRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXTextureSetRegisterInfoDynamic;
}
