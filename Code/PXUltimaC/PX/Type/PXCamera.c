...
void PXAPI PXCameraRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXCameraRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXCameraRegisterInfoDynamic;
}
