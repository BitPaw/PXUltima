...
void PXAPI PXIconSunRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXIconSunRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXIconSunRegisterInfoDynamic;
}
