...
PXPublic void PXAPI PXRectangleXYWHIFromLTRBI32(PXRectangleXYWHI32 PXREF pxRectangleXYWHI32, const PXRectangleLTRBI32 PXREF pxRectangleLTRBI32);
...
PXPublic void PXAPI PXRectangleXYWHI32AddLTRBI32(PXRectangleXYWHI32 PXREF pxRectangleXYWHI32, const PXRectangleLTRBI32 PXREF pxRectangleLTRBI32);

PXPublic PXBool PXAPI PXRectangleXYWHI32ContainsPoint(PXRectangleXYWHI32 PXREF pxRectangle, const float x, const float y);
