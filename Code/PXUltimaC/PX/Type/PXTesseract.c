...
void PXAPI PXTesseractRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXTesseractRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXTesseractRegisterInfoDynamic;
}
