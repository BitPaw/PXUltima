...
void PXAPI PXTexturePoolRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXTexturePoolRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXTexturePoolRegisterInfoDynamic;
}
