...
void PXAPI PXTextureRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXTextureRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXTextureRegisterInfoDynamic;
}
...
PXResult PXAPI PXTextureCreate(PXTexture** pxTextureREF, PXTextureCreateInfo PXREF pxTextureCreateInfo)
{
    ...
    pxTexture->Filter = PXTextureSamplingModePoint;
