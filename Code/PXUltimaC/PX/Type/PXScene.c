...
void PXAPI PXSceneRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXSceneRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXSceneRegisterInfoDynamic;
}
