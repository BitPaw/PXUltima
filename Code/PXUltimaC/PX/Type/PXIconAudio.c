...
void PXAPI PXIconAudioRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXIconAudioRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXIconAudioRegisterInfoDynamic;
}
