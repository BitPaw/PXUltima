...
void PXAPI PXLightDirectionalRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXLightDirectionalRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXLightDirectionalRegisterInfoDynamic;
}
