...
void PXAPI PXAudioDeviceRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXAudioDeviceRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXAudioDeviceRegisterInfoDynamic;
}
