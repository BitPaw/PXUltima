...
void PXAPI PXGizmoRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXGizmoRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXGizmoRegisterInfoDynamic;
}
