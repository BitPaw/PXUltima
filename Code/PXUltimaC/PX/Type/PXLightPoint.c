...
void PXAPI PXLightPointRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXLightPointRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXLightPointRegisterInfoDynamic;
}
