...
void PXAPI PXLightSpotRegisterToECS(PXECSRegisterInfo PXREF pxECSRegisterInfo)
{
    pxECSRegisterInfo->InfoStatic = &PXLightSpotRegisterInfoStatic;
    pxECSRegisterInfo->InfoDynamic = &PXLightSpotRegisterInfoDynamic;
}
