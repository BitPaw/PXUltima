...
#ifndef PXOpenGLIncluded
#define PXOpenGLIncluded
...
typedef enum PXOpenGLToggle_
{
    ...
    PXOpenGLLIGHTi, // If enabled, Included light i in the evaluation of the lighting equation. See glLightModel and glLight.
...
//---<PXOpenGL v.1.1.0>--------------------------------------------------------
typedef void (PXOpenGLAPI* PXOpenGLAccumFunction)(GLenum op, PXF32 value);
...
typedef void (PXOpenGLAPI* PXOpenGLBitmapFunction)(GLsizei width, GLsizei height, PXF32 xorig, PXF32 yorig, PXF32 xmove, PXF32 ymove, const GLubyte* bitmap);
...
typedef void (PXOpenGLAPI* PXOpenGLClearAccumFunction)(PXF32 red, PXF32 green, PXF32 blue, PXF32 alpha);
...
typedef void (PXOpenGLAPI* PXOpenGLClearIndexFunction)(PXF32 c);
...
typedef void (PXOpenGLAPI* PXOpenGLColor3fFunction)(PXF32 red, PXF32 green, PXF32 blue);
typedef void (PXOpenGLAPI* PXOpenGLColor3fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLColor4fFunction)(PXF32 red, PXF32 green, PXF32 blue, PXF32 alpha);
typedef void (PXOpenGLAPI* PXOpenGLColor4fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLEvalCoord1fFunction)(PXF32 u);
typedef void (PXOpenGLAPI* PXOpenGLEvalCoord1fvFunction)(const PXF32* u);
...
typedef void (PXOpenGLAPI* PXOpenGLEvalCoord2fFunction)(PXF32 u, PXF32 v);
typedef void (PXOpenGLAPI* PXOpenGLEvalCoord2fvFunction)(const PXF32* u);
...
typedef void (PXOpenGLAPI* PXOpenGLFeedbackBufferFunction)(GLsizei size, GLenum type, PXF32* buffer);
typedef void (PXOpenGLAPI* PXOpenGLFinishFunction)(void);
typedef void (PXOpenGLAPI* PXOpenGLFlushFunction)(void);
typedef void (PXOpenGLAPI* PXOpenGLFogfFunction)(GLenum pname, PXF32 param);
typedef void (PXOpenGLAPI* PXOpenGLFogfvFunction)(GLenum pname, const PXF32* params);
...
typedef void (PXOpenGLAPI* PXOpenGLGetPXF32vFunction)(GLenum pname, PXF32* params);
typedef void (PXOpenGLAPI* PXOpenGLGetIntegervFunction)(GLenum pname, GLint* params);
typedef void (PXOpenGLAPI* PXOpenGLGetLightfvFunction)(GLenum light, GLenum pname, PXF32* params);
...
typedef void (PXOpenGLAPI* PXOpenGLGetMapfvFunction)(GLenum target, GLenum query, PXF32* v);
typedef void (PXOpenGLAPI* PXOpenGLGetMapivFunction)(GLenum target, GLenum query, GLint* v);
typedef void (PXOpenGLAPI* PXOpenGLGetMaterialfvFunction)(GLenum face, GLenum pname, PXF32* params);
typedef void (PXOpenGLAPI* PXOpenGLGetMaterialivFunction)(GLenum face, GLenum pname, GLint* params);
typedef void (PXOpenGLAPI* PXOpenGLGetPixelMapfvFunction)(GLenum map, PXF32* values);
...
typedef void (PXOpenGLAPI* PXOpenGLGetTexEnvfvFunction)(GLenum target, GLenum pname, PXF32* params);
...
typedef void (PXOpenGLAPI* PXOpenGLGetTexGenfvFunction)(GLenum coord, GLenum pname, PXF32* params);
...
typedef void (PXOpenGLAPI* PXOpenGLGetTexLevelParameterfvFunction)(GLenum target, GLint level, GLenum pname, PXF32* params);
typedef void (PXOpenGLAPI* PXOpenGLGetTexLevelParameterivFunction)(GLenum target, GLint level, GLenum pname, GLint* params);
typedef void (PXOpenGLAPI* PXOpenGLGetTexParameterfvFunction)(GLenum target, GLenum pname, PXF32* params);
...
typedef void (PXOpenGLAPI* PXOpenGLIndexfFunction)(PXF32 c);
typedef void (PXOpenGLAPI* PXOpenGLIndexfvFunction)(const PXF32* c);
...
typedef void (PXOpenGLAPI* PXOpenGLLightModelfFunction)(GLenum pname, PXF32 param);
typedef void (PXOpenGLAPI* PXOpenGLLightModelfvFunction)(GLenum pname, const PXF32* params);
...
typedef void (PXOpenGLAPI* PXOpenGLLightfFunction)(GLenum light, GLenum pname, PXF32 param);
typedef void (PXOpenGLAPI* PXOpenGLLightfvFunction)(GLenum light, GLenum pname, const PXF32* params);
...
typedef void (PXOpenGLAPI* PXOpenGLLineWidthFunction)(PXF32 width);
...
typedef void (PXOpenGLAPI* PXOpenGLLoadMatrixfFunction)(const PXF32* m);
...
typedef void (PXOpenGLAPI* PXOpenGLMap1fFunction)(GLenum target, PXF32 u1, PXF32 u2, GLint stride, GLint order, const PXF32* points);
...
typedef void (PXOpenGLAPI* PXOpenGLMap2fFunction)(GLenum target, PXF32 u1, PXF32 u2, GLint ustride, GLint uorder, PXF32 v1, PXF32 v2, GLint vstride, GLint vorder, const PXF32* points);
typedef void (PXOpenGLAPI* PXOpenGLMapGrid1dFunction)(GLint un, GLdouble u1, GLdouble u2);
typedef void (PXOpenGLAPI* PXOpenGLMapGrid1fFunction)(GLint un, PXF32 u1, PXF32 u2);
typedef void (PXOpenGLAPI* PXOpenGLMapGrid2dFunction)(GLint un, GLdouble u1, GLdouble u2, GLint vn, GLdouble v1, GLdouble v2);
typedef void (PXOpenGLAPI* PXOpenGLMapGrid2fFunction)(GLint un, PXF32 u1, PXF32 u2, GLint vn, PXF32 v1, PXF32 v2);
typedef void (PXOpenGLAPI* PXOpenGLMaterialfFunction)(GLenum face, GLenum pname, PXF32 param);
typedef void (PXOpenGLAPI* PXOpenGLMaterialfvFunction)(GLenum face, GLenum pname, const PXF32* params);
...
typedef void (PXOpenGLAPI* PXOpenGLMultMatrixfFunction)(const PXF32* m);
...
typedef void (PXOpenGLAPI* PXOpenGLNormal3fFunction)(PXF32 nx, PXF32 ny, PXF32 nz);
typedef void (PXOpenGLAPI* PXOpenGLNormal3fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLPassThroughFunction)(PXF32 token);
typedef void (PXOpenGLAPI* PXOpenGLPixelMapfvFunction)(GLenum map, GLsizei mapsize, const PXF32* values);
...
typedef void (PXOpenGLAPI* PXOpenGLPixelStorefFunction)(GLenum pname, PXF32 param);
typedef void (PXOpenGLAPI* PXOpenGLPixelStoreiFunction)(GLenum pname, GLint param);
typedef void (PXOpenGLAPI* PXOpenGLPixelTransferfFunction)(GLenum pname, PXF32 param);
typedef void (PXOpenGLAPI* PXOpenGLPixelTransferiFunction)(GLenum pname, GLint param);
typedef void (PXOpenGLAPI* PXOpenGLPixelZoomFunction)(PXF32 xfactor, PXF32 yfactor);
typedef void (PXOpenGLAPI* PXOpenGLPointSizeFunction)(PXF32 size);
typedef void (PXOpenGLAPI* PXOpenGLPolygonModeFunction)(GLenum face, GLenum mode);
typedef void (PXOpenGLAPI* PXOpenGLPolygonOffsetFunction)(PXF32 factor, PXF32 units);
...
typedef void (PXOpenGLAPI* PXOpenGLRasterPos2fFunction)(PXF32 x, PXF32 y);
typedef void (PXOpenGLAPI* PXOpenGLRasterPos2fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLRasterPos3fFunction)(PXF32 x, PXF32 y, PXF32 z);
typedef void (PXOpenGLAPI* PXOpenGLRasterPos3fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLRasterPos4fFunction)(PXF32 x, PXF32 y, PXF32 z, PXF32 w);
typedef void (PXOpenGLAPI* PXOpenGLRasterPos4fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLRectfFunction)(PXF32 x1, PXF32 y1, PXF32 x2, PXF32 y2);
typedef void (PXOpenGLAPI* PXOpenGLRectfvFunction)(const PXF32* v1, const PXF32* v2);
...
typedef void (PXOpenGLAPI* PXOpenGLRotatefFunction)(PXF32 angle, PXF32 x, PXF32 y, PXF32 z);
typedef void (PXOpenGLAPI* PXOpenGLScaledFunction)(GLdouble x, GLdouble y, GLdouble z);
typedef void (PXOpenGLAPI* PXOpenGLScalefFunction)(PXF32 x, PXF32 y, PXF32 z);
...
typedef void (PXOpenGLAPI* PXOpenGLTexCoord1fFunction)(PXF32 s);
typedef void (PXOpenGLAPI* PXOpenGLTexCoord1fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLTexCoord2fFunction)(PXF32 s, PXF32 t);
typedef void (PXOpenGLAPI* PXOpenGLTexCoord2fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLTexCoord3fFunction)(PXF32 s, PXF32 t, PXF32 r);
typedef void (PXOpenGLAPI* PXOpenGLTexCoord3fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLTexCoord4fFunction)(PXF32 s, PXF32 t, PXF32 r, PXF32 q);
typedef void (PXOpenGLAPI* PXOpenGLTexCoord4fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLTexEnvfFunction)(GLenum target, GLenum pname, PXF32 param);
typedef void (PXOpenGLAPI* PXOpenGLTexEnvfvFunction)(GLenum target, GLenum pname, const PXF32* params);
...
typedef void (PXOpenGLAPI* PXOpenGLTexGenfFunction)(GLenum coord, GLenum pname, PXF32 param);
typedef void (PXOpenGLAPI* PXOpenGLTexGenfvFunction)(GLenum coord, GLenum pname, const PXF32* params);
...
typedef void (PXOpenGLAPI* PXOpenGLTexParameterfFunction)(GLenum target, GLenum pname, PXF32 param);
typedef void (PXOpenGLAPI* PXOpenGLTexParameterfvFunction)(GLenum target, GLenum pname, const PXF32* params);
...
typedef void (PXOpenGLAPI* PXOpenGLTranslatefFunction)(PXF32 x, PXF32 y, PXF32 z);
...
typedef void (PXOpenGLAPI* PXOpenGLVertex2fFunction)(PXF32 x, PXF32 y);
typedef void (PXOpenGLAPI* PXOpenGLVertex2fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLVertex3fFunction)(PXF32 x, PXF32 y, PXF32 z);
typedef void (PXOpenGLAPI* PXOpenGLVertex3fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLVertex4fFunction)(PXF32 x, PXF32 y, PXF32 z, PXF32 w);
typedef void (PXOpenGLAPI* PXOpenGLVertex4fvFunction)(const PXF32* v);
...
typedef void (PXOpenGLAPI* PXOpenGLUniform1fFunction)(GLint location, PXF32 v0);
typedef void (PXOpenGLAPI* PXOpenGLUniform1fvFunction)(GLint location, GLsizei count, const PXF32* value);
...
typedef void (PXOpenGLAPI* PXOpenGLUniform2fFunction)(GLint location, PXF32 v0, PXF32 v1);
typedef void (PXOpenGLAPI* PXOpenGLUniform2fvFunction)(GLint location, GLsizei count, const PXF32* value);
...
typedef void (PXOpenGLAPI* PXOpenGLUniform3fFunction)(GLint location, PXF32 v0, PXF32 v1, PXF32 v2);
typedef void (PXOpenGLAPI* PXOpenGLUniform3fvFunction)(GLint location, GLsizei count, const PXF32* value);
...
typedef void (PXOpenGLAPI* PXOpenGLUniform4fFunction)(GLint location, PXF32 v0, PXF32 v1, PXF32 v2, PXF32 v3);
typedef void (PXOpenGLAPI* PXOpenGLUniform4fvFunction)(GLint location, GLsizei count, const PXF32* value);
...
typedef void (PXOpenGLAPI* PXOpenGLUniformMatrix2fvFunction)(GLint location, GLsizei count, GLboolean transpose, const PXF32* value);
...
typedef void (PXOpenGLAPI* PXOpenGLFrameBufferLinkTexture2DFunction)(GLenum target, GLenum attachment, GLenum Arget, GLuint texture, GLint level);
...
typedef void (PXOpenGLAPI* PXOpenGLGetPXF32vFunction)(GLenum pname, PXF32* data);
typedef void (PXOpenGLAPI* PXOpenGLGetIntegervFunction)(GLenum pname, GLint* data);
typedef void (PXOpenGLAPI* PXOpenGLGetInteger64vFunction)(GLenum pname, PXI64S* data);
...
typedef void (PXOpenGLAPI* PXOpenGLGetPXF32i_vFunction)(GLenum target, GLuint index, PXF32* data);
typedef void (PXOpenGLAPI* PXOpenGLGetDoublei_vFunction)(GLenum target, GLuint index, GLdouble* data);
typedef void (PXOpenGLAPI* PXOpenGLGetInteger64i_vFunction)(GLenum target, GLuint index, PXI64U* data);
...
typedef HGLRC(PXOpenGLAPI* PXOpenGLContextCreateAttributes)(HDC hDC, HGLRC hshareContext, const int* attribList); // wglCreateConAttribsARB
...
typedef BOOL        (PXOpenGLAPI* PXOpenGLFontOutlinesUseA                 )(HDC unnamedParam1, DWORD unnamedParam2, DWORD unnamedParam3, DWORD unnamedParam4, PXF32 unnamedParam5, PXF32 unnamedParam6, int unnamedParam7, LPGLYPHMETRICSFLOAT unnamedParam8); // wglUseFontOutlinesA
typedef BOOL        (PXOpenGLAPI* PXOpenGLFontOutlinesUseW                 )(HDC unnamedParam1, DWORD unnamedParam2, DWORD unnamedParam3, DWORD unnamedParam4, PXF32 unnamedParam5, PXF32 unnamedParam6, int unnamedParam7, LPGLYPHMETRICSFLOAT unnamedParam8); // wglUseFontOutlinesW
...
typedef BOOL(PXOpenGLAPI* PXOpenGLPixelFormatAttribfvGet)(HDC hdc,
                                  ...
                                  UINT nAttributes,
                                  const int* piAttributes,
                                  PXF32* pfValues); // wglGetPixelFormatAttribfvARB

typedef BOOL(PXOpenGLAPI* PXOpenGLPixelFormatChooseARB)(HDC hdc,
                             const int* piAttribIList,
                             const PXF32* pfAttribFList,
                             UINT nMaxFormats,
                             int* piFormats,
...
typedef struct PXOpenGLBinding_
{
    ...
    PXOpenGLGetPXF32i_vFunction GetPXF32i_v;
    PXOpenGLGetPXF32vFunction    GetPXF32v;
    //PXOpenGLGetPXF32vFunction GetPXF32v;
...
{
    PXOpenGLBinding Binding; // Library-functions

    PXLibrary LibraryOpenGL; // Libary
...
PXPrivate PXShaderVariableType PXAPI PXOpenGLShaderVariableTypeFromID(const PXI16U openGLShaderVariableTypeID);

PXPrivate PXResult PXAPI PXOpenGLErrorCurrent(PXOpenGL PXREF pxOpenGL, PXBool wasSuccessultCall);
PXPrivate PXOpenGLVersion PXAPI PXOpenGLVersionParse(const PXI32U versionID);
//--------------------------------------------------------
...
PXPublic void PXAPI PXOpenGLCopy(PXOpenGL PXREF openGLContext, const PXOpenGL PXREF openGLContextSoure);

PXPublic PXResult PXAPI PXOpenGLInitialize(PXOpenGL PXREF openGLContext, PXGraphicInitializeInfo PXREF pxGraphicInitializeInfo);
PXPublic PXResult PXAPI PXOpenGLRelease(PXOpenGL PXREF openGLContext);

PXPublic PXResult PXAPI PXOpenGLSelect(PXOpenGL PXREF openGLContext);
PXPublic PXResult PXAPI PXOpenGLDeselect(PXOpenGL PXREF openGLContext);
...
PXPublic void PXAPI PXOpenGLFlush(PXOpenGL PXREF openGLContext);
PXPublic void PXAPI PXOpenGLViewPortSet(PXOpenGL PXREF openGLContext, const PXViewPort PXREF pxViewPort);
PXPublic void PXAPI PXOpenGLViewPortGet(PXOpenGL PXREF openGLContext, PXViewPort PXREF pxViewPort);

PXPublic void PXAPI PXOpenGLPolygonRenderOrder(const PXOpenGL PXREF openGLContext, const PXOpenGLPolygonRenderOrderMode openGLPolygonRenderOrderMode);

PXPublic void PXAPI PXOpenGLSettingChange(PXOpenGL PXREF openGLContext, const PXOpenGLToggle toggle, const PXBool state);

PXPublic void PXAPI PXOpenGLDrawOrder(PXOpenGL PXREF openGLContext, const PXOpenGLDrawOrderMode openGLDrawOrderMode);

PXPublic void PXAPI PXOpenGLDrawMode(PXOpenGL PXREF openGLContext, const PXDrawFillMode pxGraphicDrawFillMode, const int cullingMode);

PXPublic void PXAPI PXOpenGLClear(PXOpenGL PXREF openGLContext, const PXColorRGBAF PXREF pxColorRGBAF);

PXPublic PXBool PXAPI PXOpenGLSceneDeploy(PXOpenGL PXREF openGLContext);

PXPublic void PXAPI PXOpenGLDrawScaleF(PXOpenGL PXREF openGLContext, const PXF32 x, const PXF32 y, const PXF32 z);
PXPublic void PXAPI PXOpenGLDrawBegin(PXOpenGL PXREF openGLContext, const PXDrawMode openGLRenderMode);
PXPublic void PXAPI PXOpenGLDrawVertexXYZF(PXOpenGL PXREF openGLContext, const PXF32 x, const PXF32 y, const PXF32 z);
PXPublic void PXAPI PXOpenGLDrawColorRGBF(PXOpenGL PXREF openGLContext, const PXF32 red, const PXF32 green, const PXF32 blue);
PXPublic void PXAPI PXOpenGLDrawColorRGBAF(PXOpenGL PXREF openGLContext, const PXF32 red, const PXF32 green, const PXF32 blue, const PXF32 alpha);
PXPublic void PXAPI PXOpenGLDrawEnd(PXOpenGL PXREF openGLContext);




PXPublic void PXAPI PXOpenGLTextureParameter(PXOpenGL PXREF openGLContext, const PXTextureType textureType, const PXOpenGLTextureParameterMode pname, const PXOpenGLTextureParameterValue openGLTextureParameterValue);
PXPublic void PXAPI PXOpenGLTextureParameterI(PXOpenGL PXREF openGLContext, const PXTextureType textureType, const PXOpenGLTextureParameterMode pname, const int param);
PXPublic void PXAPI PXOpenGLTextureParameterF(PXOpenGL PXREF openGLContext, const PXTextureType textureType, const PXOpenGLTextureParameterMode pname, const PXF32 param);
...
PXPublic void PXAPI PXOpenGLDrawArrays(const PXOpenGL PXREF openGLContext, const PXDrawMode renderMode, const PXSize offset, const PXSize amount);
PXPublic void PXAPI PXOpenGLDrawElements(const PXOpenGL PXREF openGLContext, const PXDrawMode renderMode, const PXSize amount, const PXI32U pxDataType, const void PXREF indexList);



PXPublic void PXAPI PXOpenGLDrawArraysInstanced(const PXOpenGL PXREF openGLContext, const PXDrawMode renderMode, const PXSize startOffset, const PXSize amount, const PXSize instanceAmount);
...
PXPublic void PXAPI PXOpenGLTexture2DDataWrite(PXOpenGL PXREF openGLContext, PXTexture PXREF PXTexture);
//-------------------------------------------------------------------------


PXPublic void PXAPI PXOpenGLSkyboxDraw(PXOpenGL PXREF pxOpenGL, const PXRenderEntity PXREF pxRenderEntity);


//-----------------------------------------------------
// OpenGL - Shader
//-----------------------------------------------------
PXPublic PXResult PXAPI PXOpenGLShaderProgramCreate(PXOpenGL PXREF pxOpenGL, PXShaderProgram PXREF pxShaderProgram, PXShader PXREF shaderList, const PXSize amount);
PXPublic PXResult PXAPI PXOpenGLShaderProgramSelect(PXOpenGL PXREF pxOpenGL, PXShaderProgram PXREF pxShaderProgram);
PXPublic PXResult PXAPI PXOpenGLShaderProgramDelete(PXOpenGL PXREF pxOpenGL, PXShaderProgram PXREF pxShaderProgram);

PXPublic PXResult PXAPI PXOpenGLShaderVariableSet(PXOpenGL PXREF pxOpenGL, const PXShaderProgram PXREF pxShaderProgram, PXShaderVariable PXREF pxShaderVariableList, const PXSize amount);
//-------------------------------------------------------------------------

//---<Buffers>-------------------------------------------------------------
PXPublic void PXAPI PXOpenGLVertexArrayGenerate(PXOpenGL PXREF openGLContext, const unsigned int amount, unsigned int PXREF vaoList);
PXPublic void PXAPI PXOpenGLVertexArrayBind(PXOpenGL PXREF openGLContext, const unsigned int vaoID);
PXPublic void PXAPI PXOpenGLVertexArrayUnbind(PXOpenGL PXREF openGLContext);
PXPublic void PXAPI PXOpenGLVertexArrayAttributeDefine
(
    PXOpenGL PXREF openGLContext,
    const PXI32U index,
    const PXI32U size,
    const PXI32U datatype,
    const PXBool normalized,
    const PXI32U stride,
    const PXSize offset
);
PXPublic void PXAPI PXOpenGLVertexAttributeDivisor(PXOpenGL PXREF openGLContext, const PXSize index, const PXSize divisor);
PXPublic void PXAPI PXOpenGLVertexArrayEnable(PXOpenGL PXREF openGLContext, const unsigned int vertexArrayAtributeID);
PXPublic void PXAPI PXOpenGLVertexArrayDisable(PXOpenGL PXREF openGLContext, const unsigned int vertexArrayAtributeID);

PXPublic void PXAPI PXOpenGLBufferGenerate(PXOpenGL PXREF openGLContext, const unsigned int amount, unsigned int PXREF bufferIDList);
PXPublic void PXAPI PXOpenGLBufferBind(PXOpenGL PXREF openGLContext, const PXOpenGLBufferType bufferType, const unsigned int bufferID);
PXPublic void PXAPI PXOpenGLBufferData(PXOpenGL PXREF openGLContext, const PXOpenGLBufferType bufferType, const unsigned int size, const void PXREF data, const PXOpenGLStoreMode openGLStoreMode);
PXPublic void PXAPI PXOpenGLBufferUnbind(PXOpenGL PXREF openGLContext, const PXOpenGLBufferType bufferType);
//-------------------------------------------------------------------------

//-------------------------------------------------------------------------
PXPublic void PXAPI PXOpenGLFrameBufferCreate(PXOpenGL PXREF openGLContext, const unsigned int amount, unsigned int PXREF framebufferIDList);
PXPublic void PXAPI PXOpenGLRenderBufferStorage(PXOpenGL PXREF openGLContext, const PXOpenGLRenderBufferFormat internalformat, const int width, const int height);

// If we bind to 0, we select the "main window"
PXPublic void PXAPI PXOpenGLFrameBufferBind(PXOpenGL PXREF openGLContext, const PXOpenGLFrameBufferMode target, const unsigned int framebufferID);

PXPublic void PXAPI PXOpenGLFrameBufferDestroy(PXOpenGL PXREF openGLContext, const unsigned int amount, unsigned int PXREF framebufferIDList);

PXPublic void PXAPI PXOpenGLRenderBufferCreate(PXOpenGL PXREF openGLContext, GLsizei n, GLuint* renderbuffers);


PXPublic void PXAPI PXOpenGLRenderBufferBind(PXOpenGL PXREF openGLContext, const unsigned int renderbuffer);

PXPublic void PXAPI PXOpenGLRenderBufferDelete(PXOpenGL PXREF openGLContext, GLsizei n, GLuint* renderbuffers);


PXPublic void PXAPI PXOpenGLFrameBufferLinkTexture2D(PXOpenGL PXREF openGLContext, const PXOpenGLRenderBufferAttachmentPoint attachment, const PXTextureType Arget, const unsigned int textureID, const int level);
PXPublic GLuint PXAPI PXOpenGLFrameBufferLinkRenderBuffer(PXOpenGL PXREF openGLContext, const PXOpenGLRenderBufferAttachmentPoint attachment, const unsigned int renderbuffer);
//-------------------------------------------------------------------------
...
//---<PXOpenGL v.1.1.0>------------------------------------------------------
PXPublic void PXAPI PXOpenGLTexture2DDataRead(PXOpenGL PXREF openGLContext, PXTexture PXREF PXTexture);
PXPublic void PXAPI PXOpenGLTexture2DDataReadFrom(PXOpenGL PXREF openGLContext, PXTexture PXREF PXTexture, const PXI32U x, const PXI32U y, const PXI32U width, const PXI32U height);
//-------------------------------------------------------------------------
...
//---<Extensions>----------------------------------------------------------
PXPublic PXResult PXAPI PXOpenGLSwapIntervalSet(PXOpenGL PXREF openGLContext, const PXI32U interval);
PXPublic PXResult PXAPI PXOpenGLSwapIntervalGet(PXOpenGL PXREF openGLContext, PXI32U PXREF interval);
//-------------------------------------------------------------------------



PXPublic PXResult PXAPI PXOpenGLSpriteRegister(PXOpenGL PXREF pxOpenGL, PXSprite PXREF pxSprite);

//-----------------------------------------------------
// Fixed Scripting
//-----------------------------------------------------
PXPublic PXResult PXAPI PXOpenGLDrawScriptCreate(PXOpenGL PXREF pxOpenGL, PXDrawScript PXREF pxDrawScript);
PXPublic PXResult PXAPI PXOpenGLDrawScriptBegin(PXOpenGL PXREF pxOpenGL, PXDrawScript PXREF pxDrawScript);
PXPublic PXResult PXAPI PXOpenGLDrawScriptEnd(PXOpenGL PXREF pxOpenGL, PXDrawScript PXREF pxDrawScript);
PXPublic PXResult PXAPI PXOpenGLDrawScriptDelete(PXOpenGL PXREF pxOpenGL, PXDrawScript PXREF pxDrawScript);
PXPublic PXResult PXAPI PXOpenGLDrawScriptExecute(PXOpenGL PXREF pxOpenGL, PXDrawScript PXREF pxDrawScript);

//-----------------------------------------------------
// Light
//-----------------------------------------------------
PXPublic PXResult PXAPI PXOpenGLLightSet(PXOpenGL PXREF pxOpenGL, PXLight PXREF pxLight, const PXI32U index);
PXPublic PXResult PXAPI PXOpenGLLightGet(PXOpenGL PXREF pxOpenGL, PXLight PXREF pxLight, const PXI32U index);
PXPublic PXResult PXAPI PXOpenGLLightEnableSet(PXOpenGL PXREF pxOpenGL, PXLight PXREF pxLight, const PXI32U index, const PXBool enable);
PXPublic PXResult PXAPI PXOpenGLLightEnableGet(PXOpenGL PXREF pxOpenGL, PXLight PXREF pxLight, const PXI32U index, PXBool PXREF enable);
...
// PX-Extrended
//-----------------------------------------------------
PXPublic PXResult PXAPI PXOpenGLModelRegister(PXOpenGL PXREF pxOpenGL, PXModel PXREF pxModel);
PXPublic PXResult PXAPI PXOpenGLModelDraw(PXOpenGL PXREF pxOpenGL, const PXRenderEntity PXREF pxRenderEntity);
PXPublic PXResult PXAPI PXOpenGLModelDeregister(PXOpenGL PXREF pxOpenGL, PXModel PXREF pxModel);


PXPublic PXResult PXAPI PXOpenGLRectangleDraw(PXOpenGL PXREF pxOpenGL, const PXF32 xA, const PXF32 yA, const PXF32 xB, const PXF32 yB, const PXI8U mode);
PXPublic PXResult PXAPI PXOpenGLRectangleDrawTx(PXOpenGL PXREF pxOpenGL, const PXF32 xA, const PXF32 yA, const PXF32 xB, const PXF32 yB, const PXF32 txA, const PXF32 tyA, const PXF32 txB, const PXF32 tyB, const PXI8U mode);
