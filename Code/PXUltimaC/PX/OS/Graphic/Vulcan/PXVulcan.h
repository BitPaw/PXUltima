...
typedef enum PXVukanStructureType_
{
    ...
    // Provided by VK_KHR_shader_PXF3216_int8


    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_PXF3216_INT8_FEATURES_KHR = 1000081001,
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_PXF3216_INT8_FEATURES = 1000081001,
    // Provided by VK_KHR_shader_PXF3216_int8
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PXF3216_INT8_FEATURES_KHR = 1000081002,
    //VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_PXF3216_INT8_FEATURES = 1000081002,
    ...
    // Provided by VK_KHR_shader_PXF32_controls
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PXF32_CONTROLS_PROPERTIES_KHR = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PXF32_CONTROLS_PROPERTIES,
...
typedef enum VkFormat
{
    ...
    VK_FORMAT_R16G16B16A16_SPXF32 = 97,
    VK_FORMAT_R32_UINT = 98,
    VK_FORMAT_R32_SINT = 99,
    VK_FORMAT_R32_SPXF32 = 100,
    VK_FORMAT_R32G32_UINT = 101,
    VK_FORMAT_R32G32_SINT = 102,
    VK_FORMAT_R32G32_SPXF32 = 103,
    VK_FORMAT_R32G32B32_UINT = 104,
    VK_FORMAT_R32G32B32_SINT = 105,
    VK_FORMAT_R32G32B32_SPXF32 = 106,
    VK_FORMAT_R32G32B32A32_UINT = 107,
    VK_FORMAT_R32G32B32A32_SINT = 108,
    VK_FORMAT_R32G32B32A32_SPXF32 = 109,
    VK_FORMAT_R64_UINT = 110,
    VK_FORMAT_R64_SINT = 111,
    VK_FORMAT_R64_SPXF32 = 112,
    VK_FORMAT_R64G64_UINT = 113,
    VK_FORMAT_R64G64_SINT = 114,
    VK_FORMAT_R64G64_SPXF32 = 115,
    VK_FORMAT_R64G64B64_UINT = 116,
    VK_FORMAT_R64G64B64_SINT = 117,
    VK_FORMAT_R64G64B64_SPXF32 = 118,
    VK_FORMAT_R64G64B64A64_UINT = 119,
    VK_FORMAT_R64G64B64A64_SINT = 120,
    VK_FORMAT_R64G64B64A64_SPXF32 = 121,
    VK_FORMAT_B10G11R11_UPXF32_PACK32 = 122,
    VK_FORMAT_E5B9G9R9_UPXF32_PACK32 = 123,
    VK_FORMAT_D16_UNORM = 124,
    VK_FORMAT_X8_D24_UNORM_PACK32 = 125,
    VK_FORMAT_D32_SPXF32 = 126,
    VK_FORMAT_S8_UINT = 127,
    VK_FORMAT_D16_UNORM_S8_UINT = 128,
    VK_FORMAT_D24_UNORM_S8_UINT = 129,
    VK_FORMAT_D32_SPXF32_S8_UINT = 130,
    ...
    VK_FORMAT_BC6H_UPXF32_BLOCK = 143,
    VK_FORMAT_BC6H_SPXF32_BLOCK = 144,
    ...
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_4x4_SPXF32_BLOCK = 1000066000,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_5x4_SPXF32_BLOCK = 1000066001,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_5x5_SPXF32_BLOCK = 1000066002,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_6x5_SPXF32_BLOCK = 1000066003,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_6x6_SPXF32_BLOCK = 1000066004,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_8x5_SPXF32_BLOCK = 1000066005,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_8x6_SPXF32_BLOCK = 1000066006,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_8x8_SPXF32_BLOCK = 1000066007,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_10x5_SPXF32_BLOCK = 1000066008,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_10x6_SPXF32_BLOCK = 1000066009,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_10x8_SPXF32_BLOCK = 1000066010,

    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_10x10_SPXF32_BLOCK = 1000066011,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_12x10_SPXF32_BLOCK = 1000066012,
    // Provided by VK_VERSION_1_3
    VK_FORMAT_ASTC_12x12_SPXF32_BLOCK = 1000066013,
    ...
    VK_FORMAT_ASTC_4x4_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_4x4_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_5x4_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_5x4_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_5x5_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_5x5_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_6x5_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_6x5_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_6x6_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_6x6_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_8x5_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_8x5_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_8x6_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_8x6_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_8x8_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_8x8_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_10x5_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_10x5_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_10x6_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_10x6_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_10x8_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_10x8_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr

    VK_FORMAT_ASTC_10x10_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_10x10_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_12x10_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_12x10_SPXF32_BLOCK,
    // Provided by VK_EXT_texture_compression_astc_hdr
    VK_FORMAT_ASTC_12x12_SPXF32_BLOCK_EXT = VK_FORMAT_ASTC_12x12_SPXF32_BLOCK,
    // Provided by VK_KHR_sampler_ycbcr_conversion
