...
PXResult PXAPI PXDirectX10x1Initialize(PXDirectX10x1 PXREF pxDirectX10x1)
{
#if PXLogEnable
    PXLogPrint
    (
...
PXResult PXAPI PXDirectX10x1Release(PXDirectX10x1 PXREF pxDirectX10x1)
{
    return PXActionRefusedNotImplemented;
}
