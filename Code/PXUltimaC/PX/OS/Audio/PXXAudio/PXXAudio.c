...
PXActionResult PXAPI PXXAudioDevicePitchIncrease(PXAudioXSystem* const pxAudioXSystem, PXAudioDevice* const pxAudioDevice, PXF32 amount)
{
    return PXActionRefusedNotImplemented;
}
...
PXActionResult PXAPI PXXAudioDevicePitchReduce(PXAudioXSystem* const pxAudioXSystem, PXAudioDevice* const pxAudioDevice, PXF32 amount)
{
    return PXActionRefusedNotImplemented;
}
