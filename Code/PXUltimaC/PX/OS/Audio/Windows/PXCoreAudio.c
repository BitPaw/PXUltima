...
PXActionResult PXAPI PXCoreAudioInitialize(PXAudio* const pxAudio)
{
    ...
    while(1) {
        ...
        for(UINT32 i = 0; i < numFramesAvailable; i++) {
            ...
            PXInt16U s = (PXInt16U)(sample * 32767);
            ((PXInt16U*)pData)[2 * i + 0] = s; // Left
            ((PXInt16U*)pData)[2 * i + 1] = s; // Right
            t += dt;
        }
