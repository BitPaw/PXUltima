...
PXPublic PXActionResult PXAPI PXDirectSoundDevicePositionSet(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, const PXF32 x, const PXF32 y, const PXF32 z);
PXPublic PXActionResult PXAPI PXDirectSoundDevicePositionGet(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, PXF32* const x, PXF32* const  y, PXF32* const  z);
...
PXPublic PXActionResult PXAPI PXDirectSoundDeviceConeOrientationGet(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, PXF32* const x, PXF32* const  y, PXF32* const  z);
PXPublic PXActionResult PXAPI PXDirectSoundDeviceConeOrientationSet(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, const PXF32 x, const PXF32 y, const PXF32 z);
...
PXPublic PXActionResult PXAPI PXDirectSoundDeviceDistanceMaxGet(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, PXF32* const pflMaxDistance);
PXPublic PXActionResult PXAPI PXDirectSoundDeviceDistanceMaxSet(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, const PXF32 flMaxDistance);
PXPublic PXActionResult PXAPI PXDirectSoundDeviceDistanceMinGet(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, PXF32* const pflMinDistance);
PXPublic PXActionResult PXAPI PXDirectSoundDeviceDistanceMinSet(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, const PXF32 flMinDistance);
...
PXPublic PXActionResult PXAPI PXDirectSoundDeviceVelocityGet(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, PXF32* const x, PXF32* const y, PXF32* const z);
PXPublic PXActionResult PXAPI PXDirectSoundDeviceVelocitySet(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, const PXF32 x, const PXF32 y, const PXF32 z);
...
// Device - Pitch
//--------------------------------------------------------
PXPublic PXActionResult PXAPI PXDirectSoundDevicePitchIncrease(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, PXF32 amount);
...
PXPublic PXActionResult PXAPI PXDirectSoundDevicePitchReduce(PXAudioDirectSound* const pxAudioDirectSound, PXAudioDevice* const pxAudioDevice, PXF32 amount);
