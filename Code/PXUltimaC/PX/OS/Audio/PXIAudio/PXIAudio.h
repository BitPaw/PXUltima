...
PXPublic PXActionResult PXAPI PXIAudioDevicePositionSet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, const PXF32 x, const PXF32 y, const PXF32 z);
PXPublic PXActionResult PXAPI PXIAudioDevicePositionGet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32* const x, PXF32* const  y, PXF32* const  z);
...
PXPublic PXActionResult PXAPI PXIAudioDeviceConeOrientationGet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32* const x, PXF32* const  y, PXF32* const  z);
PXPublic PXActionResult PXAPI PXIAudioDeviceConeOrientationSet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, const PXF32 x, const PXF32 y, const PXF32 z);
...
PXPublic PXActionResult PXAPI PXIAudioDeviceDistanceMaxGet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32* const pflMaxDistance);
PXPublic PXActionResult PXAPI PXIAudioDeviceDistanceMaxSet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, const PXF32 flMaxDistance);
PXPublic PXActionResult PXAPI PXIAudioDeviceDistanceMinGet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32* const pflMinDistance);
PXPublic PXActionResult PXAPI PXIAudioDeviceDistanceMinSet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, const PXF32 flMinDistance);
...
PXPublic PXActionResult PXAPI PXIAudioDeviceVelocityGet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32* const x, PXF32* const y, PXF32* const z);
PXPublic PXActionResult PXAPI PXIAudioDeviceVelocitySet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, const PXF32 x, const PXF32 y, const PXF32 z);
...
// Device - Pitch
//--------------------------------------------------------
PXPublic PXActionResult PXAPI PXIAudioDevicePitchIncrease(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32 amount);
...
PXPublic PXActionResult PXAPI PXIAudioDevicePitchReduce(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32 amount);
