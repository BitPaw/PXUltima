...
PXActionResult PXAPI PXIAudioDevicePositionSet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, const PXF32 x, const PXF32 y, const PXF32 z)
{
    return PXActionRefusedNotImplemented;
}

PXActionResult PXAPI PXIAudioDevicePositionGet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32* const x, PXF32* const y, PXF32* const z)
{
    return PXActionRefusedNotImplemented;
}
...
PXActionResult PXAPI PXIAudioDeviceConeOrientationGet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32* const x, PXF32* const y, PXF32* const z)
{
    return PXActionRefusedNotImplemented;
}

PXActionResult PXAPI PXIAudioDeviceConeOrientationSet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, const PXF32 x, const PXF32 y, const PXF32 z)
{
    return PXActionRefusedNotImplemented;
}
...
PXActionResult PXAPI PXIAudioDeviceDistanceMaxGet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32* const pflMaxDistance)
{
    return PXActionRefusedNotImplemented;
}

PXActionResult PXAPI PXIAudioDeviceDistanceMaxSet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, const PXF32 flMaxDistance)
{
    return PXActionRefusedNotImplemented;
}

PXActionResult PXAPI PXIAudioDeviceDistanceMinGet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32* const pflMinDistance)
{
    return PXActionRefusedNotImplemented;
}

PXActionResult PXAPI PXIAudioDeviceDistanceMinSet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, const PXF32 flMinDistance)
{
    return PXActionRefusedNotImplemented;
}
...
PXActionResult PXAPI PXIAudioDeviceVelocityGet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32* const x, PXF32* const y, PXF32* const z)
{
    return PXActionRefusedNotImplemented;
}

PXActionResult PXAPI PXIAudioDeviceVelocitySet(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, const PXF32 x, const PXF32 y, const PXF32 z)
{
    return PXActionRefusedNotImplemented;
}
...
PXActionResult PXAPI PXIAudioDevicePitchIncrease(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32 amount)
{
    return PXActionRefusedNotImplemented;
}
...
PXActionResult PXAPI PXIAudioDevicePitchReduce(PXAudio* const pxAudio, PXAudioDevice* const pxAudioDevice, PXF32 amount)
{
    return PXActionRefusedNotImplemented;
}
