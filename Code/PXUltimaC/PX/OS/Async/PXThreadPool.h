...
PXPrivate PXResult PXAPI  PXThreadPoolThreadSelf(PXThreadPool* const pxThreadPool, PXThread* const pxThread);
PXPrivate PXResult PXAPI  PXThreadPoolTaskInvoke(PXThreadPool* const pxThreadPool, PXTask* const pxTask);
...
PXPublic PXResult PXAPI PXThreadPoolThreadMaximumSet(PXThreadPool* const pxThreadPool, const PXI32U amount);
PXPublic PXResult PXAPI PXThreadPoolThreadMinimumSet(PXThreadPool* const pxThreadPool, const PXI32U amount);
...
PXPublic PXResult PXAPI PXThreadPoolQueueWork(PXThreadPool* const pxThreadPool, const PXI32U taskID, void* function, void* parameter1, void* parameter2, const PXI32U behaviour);
...
PXPublic PXResult PXAPI PXThreadPoolProcessSYNC(PXThreadPool* const pxThreadPool);
