...
void PXAPI PXPhysicGravityApply(PXPhysicProperties* const physicProperties, const PXVector3F* const gravityDircetion, const PXF32 gravityForce, const PXF32 deltaTime)
{
    // TODO: Rewrite code
